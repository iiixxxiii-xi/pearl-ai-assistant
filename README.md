...
| 4 | **DeepSeek Rerank** | LLM 精排 Top-3；75 条小知识库下候选少，复用 DeepSeek API 避免额外部署模型。规模增长后切 BGE-reranker |
| 5 | **Query 改写** | 口语短输入自动补全再检索 |
...
| 26 | **客户画像策略** | 5 维度（性格/预算/用途/品质/了解程度）各配策略 |
| 27 | **单元测试** | 17 个测试覆盖检索/API/库存逻辑/RRF 融合/语义记忆 |
